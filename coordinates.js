  ...
  if(renderer.contextType != '2d') {
    ...
    ret.vert = `
      ...
      void main(){
        ...
        if(isLine != 0.0){
          X = (position.x * pow(scaleX, 2.0) + offset.x) / resolution.x * fov / scaleX;
          Y = (position.y * pow(scaleY, 2.0) + offset.y) / resolution.y * fov / scaleY;
          Z = (position.z * pow(scaleZ, 2.0) + offset.z) / scaleZ;
