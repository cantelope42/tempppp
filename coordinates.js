  ...
  if(renderer.contextType != '2d') {
    ...
    ret.vert = `
      ...
      void main(){
        ...
        if(isLine != 0.0){
          X = (position.x * scaleX * 2.0 + offset.x) / resolution.x * fov / scaleX;
          Y = (position.y * scaleY * 2.0 + offset.y) / resolution.y * fov / scaleY;
          Z = (position.z * scaleZ * 2.0 + offset.z) / scaleZ;
